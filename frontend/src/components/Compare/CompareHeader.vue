<template>
    <div>
        <span class="text--secondary mr-6">Обновление остатков: {{download.date ? formatDate(download.date) : '...'}}</span>
        <v-btn color="primary" small @click="downloadStocks" :loading="downloadActive">Обновить</v-btn>
    </div>
</template>
